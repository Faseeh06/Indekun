...
export default function TestimonialsSection() {
  ...
  const testimonials = [
    ...
    {
      quote:
        "Indekun has revolutionized how we manage equipment bookings. The system saves us hours every week and eliminates scheduling conflicts completely.",
      name: "Sarah Chen",
    ...
    {
      quote:
        "The equipment booking system is a game-changer. What used to take our team days now happens automatically with perfect accuracy.",
